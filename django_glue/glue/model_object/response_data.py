...
@dataclass
class GlueModelObjectJsonData(BaseJsonData):  # This is a little duplicated but allows us to send more response data.
...
@dataclass
class MethodGlueModelObjectJsonData(BaseJsonData):
    method_return: Any
